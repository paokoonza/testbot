...
cl.login(token="EnZ9erFS4INbwZ25GsZc.DU6xYokC/xQjZ1biq0d1da.1JyAkFY3Sd/zAFWdIbRzAUPI2JneVOGrlQQ/YuEzSYk=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="EnC1w9mLHiCSH64hcJba.PFXzqQLJ+9VQr1tO0qoqgG.0ZqO9wXT6+2WmOhz9YWFKL0zDiz4BVjC+cqJV93Y9GU=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="EnLnwb30kFQOcF3CSgl3.z3/s6DxOmDUtGPTOktVFeW.8IAQC5KA/7gsclRc6YopjJpDgnhfM1C4OfDl50MxrOc=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="EnAhESt54JW2DXpaZM72.+mqFDynoxhlr0ICWnX/ZaG.vJXEqoAuFR9WkBWSXq2j7y/piJaF0yw0UHux4LtAEVE=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EnXqxIF5IY9fcLeddzYa.OCTUHf+O8MrV6kxfKrHb/G.BjR9NskLWZFWGNxj6XaGcmSOA7lpzLGIhVKpyxK8dNc=")
ks.loginResult()
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["หำมา","มา","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"กูไลค์แล้ว/nid [socool270]")
                try:
                  likePost()
                except:
                  pass
